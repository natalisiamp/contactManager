...
function getContactInfo(){
	...
	//This globally saves the variables of the contact
...
function doTest() {
    ...
    try
    {
        xhr.onreadystatechange = function()
        {
            ...
            if (this.readyState == 4 && this.status == 200)
            {
                ...
                document.getElementById('firstName').setAttribute('value', jsonObject.FirstName);
                document.getElementById('lastName').setAttribute('value', jsonObject.LastName);
                document.getElementById('phoneNumber').setAttribute('value', jsonObject.Phone);
                document.getElementById('emailVal').setAttribute('value', jsonObject.Email);
                document.getElementById('address').setAttribute('value', jsonObject.Address);
                document.getElementById('notes').setAttribute('value', jsonObject.Notes);
    ...
    {
        document.getElementById('notes').setAttribute('value', "error");
    }
}
